                ...
                <div class="rp-nav-list | border-bottom-2">
                    ...
                    @if(Auth::user()->role == 1)
                        <div class="rp-list-item">
                            <a class="rp-list-link | d-flex align-items-center px-3 fs-500 fw-semi-bold"
                               href="/songs/create">
                                <img alt="" aria-hidden="true" class="rp-list-img | py-2"
                                     src="img/icon/icon_add_001_212427_32x32.svg">Toevoegen</a>
                        </div>
                    @endif
                </div>
                <div class="collapsable | d-grid">
                    ...
                    <div class="collapsable-btn genre-btn even-column-r-auto | d-grid px-4">
                        ...
                        <img alt="" aria-hidden="true" class="collapsable-img"
                             src="img/icon/icon_arrow_down_001_212427_32x32.svg">
                    </div>
                </div>
            ...
            <div class="rp-main-content container-sm">
                ...
                <div class="collapsable-sm">
                    <div class="collapsable-btn-sm | d-flex justify-content-center px-4">
                        ...
                        <img alt="" aria-hidden="true" class="collapsable-sm-img | ps-2"
                             src="img/icon/icon_filter_001_FFFFFF_32x32.svg">
                    </div>
                </div>
                <div>
                    <div class="rp-sidenav">
                        <div class="rp-sidenav-header | d-grid align-items-center py-3 px-4 w-100">
                            ...
                            <div class="close-btn | d-flex justify-content-end fs-700 fw-semi-bold">
                                <img alt="" aria-hidden="true" class="rp-sidenav-close"
                                     src="img/icon/icon_cross_001_212427_32x32.svg"></div>
                        </div>
                        ...
                        <div class="collapsable-content-sm rp-sort-sm | py-2">
                            <form class="rp-sort-form" action="#" method="GET">
                                <button
                                    class="rp-sort-btn @if($currentSort == 'A-Z_Title') rp-sort-btn-active @endif | m-1"
                                    type="submit" name="sort" value="A-Z_Title">A-Z (Titel)
                                </button>
                                <button
                                    class="rp-sort-btn @if($currentSort == 'Z-A_Title') rp-sort-btn-active @endif | m-1"
                                    type="submit" name="sort" value="Z-A_Title">Z-A (Titel)
                                </button>
                                <button
                                    class="rp-sort-btn @if($currentSort == 'A-Z_Artist') rp-sort-btn-active @endif | m-1"
                                    type="submit" name="sort" value="A-Z_Artist">A-Z (Artiest)
                                </button>
                                <button
                                    class="rp-sort-btn @if($currentSort == 'Z-A_Artist') rp-sort-btn-active @endif | m-1"
                                    type="submit" name="sort" value="Z-A_Artist">Z-A (Artiest)
                                </button>
                                <button
                                    class="rp-sort-btn @if($currentSort == 'Most_Recent') rp-sort-btn-active @endif | m-1"
                                    type="submit" name="sort" value="Most_Recent">Meest Recent
                                </button>
                            </form>
                        </div>
                        <div class="collapsable-sm">
                            ...
                            <tr class="table-row song_{{$song['id']}}">
                                ...
                                <td class="table-column-sm">
                                    <form action="{{ route('song.favourite', $song['id']) }}" method="post">
                                        @csrf
                                        <button @if($song['isFavorite']) aria-label="verwijder van uw favorieten"
                                                @else aria-label="voeg toe aan uw favorieten"
                                                @endif class="table-column-sm-btn @if($song['isFavorite'])favorite-fill @endif | d-flex align-items-center"
                                                type="submit">
                                ...
                                <td class="table-column-sm">
                                    <img alt="Download {{ $song['title'] }}" class="table-column-icon"
                                         src="img/icon/icon_download_001_212427_32x32.svg">
                                </td>
                                <td class="table-column-lg">
                                    ...
                                    <button data-toggle="modal" data-target="#modal_song_{{$song['id']}}"
                                            class="table-column-button"><img alt="Details"
                                                                             class="table-column-icon"
                                                                             src="img/icon/icon_more_001_212427_32x32.svg">
                                    </button>
                                </td>
                                <div tabindex="-1" role="dialog" aria-label="Details" id="modal_song_{{$song['id']}}"
                                     aria-hidden="true" class="table-menu song_{{$song['id']}}">
                                    ...
                                    <ul class="table-list">
                                        ...
                                        <li class="table-list-item"><a class="table-list-link | fs-500 fw-semi-bold"
                                                                       href="">
                                                <img alt="" aria-hidden="true" class="table-list-icon"
                                    ...
                                    <div class="table-bottom | py-4 fw-bold text-center">
                                        <button data-dismiss="modal" aria-hidden="true" class="table-close">Sluiten
                                        </button>
                                    </div>
                                </div>
                            </tr>
