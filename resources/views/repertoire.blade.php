                ...
                <div>
                    <ul class="rp-nav-list">
                        <li class="rp-list-item">
                            <a class="rp-list-link | fw-semi-bold" href=""><img
                                    src="img/icon/icon_playlist_001_212427_32x32.svg">Afspeellijsten</a>
                        </li>
                        <li class="rp-list-item">
                            <a class="rp-list-link | fw-semi-bold" href="{{ route('favourites') }}"><img
                                    src="img/icon/icon_favorite_002_212427_32x32.svg">Favorieten</a>
                        </li>
                        <li class="rp-list-item">
                            <a class="rp-list-link | fw-semi-bold" href="/songs/create"><img
            ...
            <div>
                <div class="">
                    ...
                    <div class="rp-top-header-section | d-grid">
                        <div class="rp-top-btn-genre | d-flex justify-content-center py-3"><h3 class="fw-semi-bold">
                                Genre</h3><img src="img/icon/icon_arrow_down_001_212427_32x32.svg"></div>
                        <div class="rp-top-btn-sort | d-flex justify-content-center rp-top-header-mid | py-3"><h3
                                class="fw-semi-bold">Sorteren</h3><img
                                src="img/icon/icon_arrow_down_001_212427_32x32.svg"></div>
                        <div class="d-flex justify-content-center py-3"><h3 class="fw-semi-bold">Favorieten</h3><img
                                src="img/icon/icon_favorite_002_212427_32x32.svg"></div>
                    </div>
                    <div class="">
                        ...
                        <div class="rp-top-menu-sort">
                            <form class="rp-top-menu-sort-form | d-grid" action="#" method="GET">
                                <button type="submit" name="sort" value="A-Z_Title">A-Z (Titel)</button>
                                <button type="submit" name="sort" value="A-Z_Artist">A-Z (Artiest)</button>
                                <button type="submit" name="sort" value="Most_Recent">Meest Recent</button>
                                <button type="submit" name="sort" value="Z-A_Title">Z-A (Titel)</button>
                                <button type="submit" name="sort" value="Z-A_Artist">Z-A (Artiest)</button>
                            </form>
                        </div>
                    </div>
                </div>
...
{{--                                Currently doesn't background color for some reason, but does change classes--}}
                                        @if($song['isFavorite'])
                                            bg-warning
                                        @else
                                            bg-primary
                                    ...
                                    <form action="{{ route('song.favourite', $song['id']) }}" method="post">
                                        @csrf
                                        <button type="submit">
                                            <img class="table-column-icon"
                                                 src="img/icon/icon_favorite_002_212427_32x32.svg">
                                        </button>
                                    </form>
                                </td>
                                <td class="table-column-sm">
                                    ...
                                    <ul class="table-list">
                                        <li class="table-list-item"><a class="table-list-link | fs-500 fw-semi-bold"
                                                ...
                                                <img class="table-list-icon"
                                                     src="img/icon/icon_favorite_002_212427_32x32.svg">Favoriet</a></li>
                                        <li class="table-list-item"><a class="table-list-link | fs-500 fw-semi-bold"
                                                                       href="">
                                                <img class="table-list-icon"
