...
@section('content')
    <section class="mt-6">
        <div class="psbr-content">
            <div class="psbr-side-menu">
                <div class="psbr-header">
                    <h2>Repertoire</h2>
                    <p>Alle Nummers</p>
                </div>
                <div>
                    <ul class="psbr-list">
                        <li><a class="psbr-list-link | fw-medium" href=""><img src="">Afspeellijsten</a></li>
                        <li><a class="psbr-list-link | fw-medium" href="{{ route('favourites') }}"><img src="">Favorieten</a></li>
                        <li><a class="psbr-list-link | fw-medium" href="/songs/create"><img src="">Toevoegen +</a></li>
                    </ul>
                </div>
                <div class="psbr-playlist-list">
        ...
        <div>
            <div class="psbr-top-menu">
                <div class="psbr-top-menu-left">
                    <h3>Genre</h3>
                </div>
                <div class="psbr-top-menu-mid">
                    <h3>Filteren</h3>
                ...
                <div class="psbr-top-menu-right">
                    <h3>Zoeken</h3>
                    <form action="#" method="GET">
                        <input class="psbr-search" type="text" name="search" placeholder="Zoeken"
            ...
            <div class="psbr-song-list">
                <table class="psbr-table">
                    <tr>
                        <th class="th-1">#</th>
                        <th class="th-2"></th>
                        <th class="th-3">Titel</th>
                        <th class="th-3">Artiest</th>
                        <th class="th-4">Genre</th>
                        <th class="th-5">Datum Toegevoegd</th>
                        <th class="th-6"></th>
                        <th class="th-6"></th>
                        <th class="th-6"></th>
                    </tr>
