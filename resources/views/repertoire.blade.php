        ...
        <div class="rp-content even-column-l-auto | d-grid px-3">
            <div class="rp-side-content container-sm | border-end-2-lg">
                ...
                <div class="collapsable | d-grid">
                        <a class="collapsable-btn | d-flex align-items-center px-3 fs-500 fw-semi-bold" href="{{route('favourites')}}">
                            <svg class="rp-list-img rp-list-svg | py-2" width="32.099998" height="30.637501" viewBox="0 0 32.1 30.6" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                <polygon class="favorite-fill" points="16,1.5 20.6,10.7 31,12.2 23.5,19.4 25.3,29.5 16,24.7 6.7,29.5 8.5,19.4 1,12.2 11.4,10.7 "/>
                            </svg>Favorieten</a>
            ...
            <div class="rp-main-content container-sm">
                ...
                <div class="collapsable-sm">
                    <div class="collapsable-btn-sm | d-flex justify-content-center px-4">
                        ...
                        <img class="collapsable-sm-img | ps-2" aria-hidden="true" src="img/icon/icon_filter_001_FFFFFF_32x32.svg" alt="">
                    </div>
                </div>
                <div>
                    <div class="rp-sidenav">
                        <div class="rp-sidenav-header | d-grid align-items-center py-3 px-4 w-100">
                            ...
                            <div class="close-btn | d-flex justify-content-end fs-700 fw-semi-bold">
                                <img class="rp-sidenav-close" aria-hidden="true" src="img/icon/icon_cross_001_212427_32x32.svg" alt=""></div>
                        </div>
                        ...
                        <tr class="table-row song_{{$song['id']}}">
                            ...
                            <td class="table-column-lg">
                                ...
                                {{-- ToDo: placeholder image--}}
                                    <img class="table-column-img" src="img/icon_default_album_cover_001.png" alt="">
                                @endif
                             </td>
                            ...
                            <td class="table-column-sm">
                                <form action="{{ route('song.favourite', $song['id']) }}" method="post">
                                    @csrf
                                    <button @if($song['isFavorite']) aria-label="Verwijder van uw favorieten" @else aria-label="Voeg toe aan uw favorieten" @endif 
                                            class="table-column-sm-btn @if($song['isFavorite'])favorite-fill @endif | d-flex align-items-center" type="submit">
                            ...
                            <td class="table-column-lg">
                                ...
                                <button class="table-column-button" data-toggle="modal" data-target="#modal_song_{{$song['id']}}">
                                    <img class="table-column-icon" src="img/icon/icon_more_001_212427_32x32.svg" alt="Details">
                                </button>
                            </td>
                            <div class="table-menu song_{{$song['id']}}" id="modal_song_{{$song['id']}}" tabindex="-1" role="dialog" aria-label="Details" aria-hidden="true" >
                                ...
                                <ul class="table-list">
                                    ...
                                    <li class="table-list-item"><a class="table-list-link | fs-500 fw-semi-bold"nhref="">
                                        <img class="table-list-icon" aria-hidden="true" src="img/icon/icon_download_001_212427_32x32.svg" alt="">Download</a></li>
                                    <li class="table-list-item"><a class="table-list-link | fs-500 fw-semi-bold" href="{{ route('songs.show', $song['id']) }}">
                                        <img class="table-list-icon" aria-hidden="true" src="img/icon/icon_more_001_212427_32x32.svg" alt="">Details</a></li>
                                </ul>
                                <div class="table-bottom | py-4 fw-bold text-center">
                                    <button class="table-close" data-dismiss="modal" aria-hidden="true">Sluiten</button>
                                </div>
                            </div>
                        </tr>
                        @endforeach
