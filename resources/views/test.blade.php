...
@section('content')
        ...
        <div class="psb-hero container | d-grid align-items-center">
            ...
            <div class="">
                ...
                <div class="d-flex justify-content-end">
                    <a href="" aria-label="facebook"><img class="psb-socials-icon | px-1" src="img/icon/icon_socials_facebook_001_5F3F6D_32x32.svg"></a>
                    <a href="" aria-label="instagram"><img class="psb-socials-icon | px-1" src="img/icon/icon_socials_instagram_001_5F3F6D_32x32.svg"></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-6">
        ...
        <div class="psb-events-boxes container | d-grid">
            <div class="psb-events-column | px-5">
                <h3 class="psb-events-header | mb-4 fs-700 fw-semi-bold">Lorum Ipsum</h3>
                <p class="psb-events-sm-txt | mb-3 pt-3 fs-300 fw-light">8 November 2022</p>
                <p class="psb-events-txt | my-4 pb-4 fs-500 fw-regular">
                ...
                <div class="d-flex justify-content-end mb-4">
                    <button class="psb-events-btn button-primary">Lees Verder</button>
                </div>
            </div>
            <div class="psb-events-column | px-5">
                <h3 class="psb-events-header | mb-4 fs-700 fw-semi-bold">Lorum Ipsum</h3>
                <p class="psb-events-small-txt | mb-3 pt-3 fs-300 fw-light">8 November 2022</p>
                <p class="psb-events-txt | my-4 pb-4 fs-500 fw-regular">
                    Lorem ipsum dolor sit amet, 
                    consectetur adipiscing elit, 
                    sed do eiusmod tempor incididunt 
    ...
    <section class="py-6">
        ...
        <div class="psb-carousel container | d-grid">
